...
function normalizeSpec(spec) {
  return String(spec || '').replace(/^[^\d]*/, ''); // "^10.7.0" -> "10.7.0"
}
...
function replaceReadme(readme, versions) {
  ...
  readme = readme.replace(/OpenLayers v[\d.]+/g, `OpenLayers v${versions.ol}`);
...
const versionsForReadme = {
  ol: normalizeSpec(pkg.dependencies?.ol),
